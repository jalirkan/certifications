...
Eleven cases ship today, every domain covered and weighted roughly to the blueprint: two on audit
execution and planning (D1), two on IT governance (D2), one on systems implementation (D3), three
on operations and resilience (D4), three on protection of information assets (D5).
...
| Branching cases | 11, with graded options, taints and a path debrief |
